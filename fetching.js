...
window.fetchFamilyData = function () {
  ...
  return new Promise((resolve, reject) => {
    fetch(`https://sheets.googleapis.com/v4/spreadsheets/1PNOyJh2a5RVcvDzGMztuV5c61b-Ouye12mzD1ImUzww/values/family-guy?alt=json&key=AIzaSyDpIfv3g92V_-NpRrGRRvRv8eidaSDHWgY`)
